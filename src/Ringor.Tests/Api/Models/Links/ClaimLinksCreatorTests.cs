        ...
        public class CreateLinksFor : ClaimLinksCreatorTests {
            ...
            public CreateLinksFor() {
                ...
                A.CallTo(() => _hyperlinkFactory.Create(A<HttpMethod>._, A<string>._, A<ClaimHyperlinkType>._))
                    .ReturnsLazily(call => {
                        ...
                        return new Hyperlink<ClaimHyperlinkType>(method, $"https://recomatics.com/testing{relativeUrl}", rel);
                    });
            }
            ...
            public async Task AddsExpectedLinksToModel() {
                ...
                var expected = new Claim {
                    ...
                    Value = "v1",
                    Links = new[] {
                        new Hyperlink<ClaimHyperlinkType>(HttpMethod.Get, "https://recomatics.com/testing/api/userinfo/c1", ClaimHyperlinkType.EnumerateAllClaimsOfThisType),
